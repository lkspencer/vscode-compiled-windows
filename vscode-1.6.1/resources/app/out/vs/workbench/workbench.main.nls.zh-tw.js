...
define("vs/workbench/workbench.main.nls.zh-tw", {
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"終端機在 OS X 上使用的殼層路徑。",
		"在 OS X 終端機要使用的命令列引數。",
		"終端機在 Windows 上使用的殼層路徑。使用隨附於 Windows 的殼層 (cmd、PowerShell 或 Bash on Ubuntu) 時，建議選擇 C:Windowssysnative 而非 C:WindowsSystem32，以使用 64 位元版本。",
