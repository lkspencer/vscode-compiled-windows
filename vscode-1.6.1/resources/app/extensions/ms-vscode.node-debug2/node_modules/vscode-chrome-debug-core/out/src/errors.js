...
function attributePathRelative(attribute, path) {
    return withInfoLink(2008, utils_1.localize('attribute.path.not.absolute', "Attribute '{0}' is not absolute ('{1}'); consider adding '{2}' as a prefix to make it absolute.", attribute, '{path}', '${workspaceRoot}/'), { path: path }, 20003);
}
