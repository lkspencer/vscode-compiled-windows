...
define("vs/workbench/electron-browser/workbench.main.nls.ja", {
	...
	"vs/platform/actions/electron-browser/menusExtensionPoint": [
		...
		"プロパティ `{0}` は必須で、`string` または `object` の型でなければなりません",
		"プロパティ `{0}` は必須で、型 `string` でなければなりません",
		"プロパティ `{0}` と `{1}` は必須で、型 `string` でなければなりません",
		"実行するコマンドの識別子",
	...
	"vs/workbench/common/theme": [
		...
		"アクティビティ バーの項目のドラッグ アンド ドロップ フィードバックの色。アクティビティ バーは左端または右端に表示され、サイド バーの表示を切り替えることができます。",
	...
	"vs/workbench/parts/debug/node/debugAdapter": [
		...
		"構成の種類。",
		"デバッグの種類は認識されませんでした。対応するデバッグの拡張機能をインストールしてください。",
	...
	"vs/workbench/parts/explorers/browser/treeExplorer.contribution": [
		"カスタム ビューを提供します",
		"vscode.workspace.createTreeView を介して生成した、ビューを認識するための一意の ID",
