...
define("vs/workbench/electron-browser/workbench.main.nls.ja", {
	...
	"vs/platform/markers/common/problemMatcher": [
		...
		"監視パターンの開始と終了を追跡するパターン。",
		"このプロパティは使用されなくなりました。代わりに watching プロパティをご使用ください。",
	...
	"vs/workbench/common/theme": [
		"タブ コンテナーの背景色。タブはエディター領域内にあるエディターのコンテナーです。複数のタブを 1 つのエディター グループで開くことができます。複数のエディター グループがある可能性があります。",
		...
		"エディター グループの背景色。エディター グループはエディターのコンテナーです。",
		"エディターのドラッグ時の背景色。",
		...
		"ステータス バーの情報項目の背景色。ステータス バーはウィンドウの下部に表示されます",
		"ホバーしたときのステータス バーの情報項目の背景色。ステータス バーはウィンドウの下部に表示されます",
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"フォルダーを再度開きません。",
		"最後にアクティブだったフォルダーを再び開きます。",
		"最後のセッションの全フォルダーを再び開きます。",
	...
	"vs/workbench/parts/debug/browser/exceptionWidget": [
		"例外ウィジェットの境界線の色",
		"例外ウィジェットの背景色",
		"ユーザーによりハンドルされる例外が発生しました。",
		"Always-breaking exception has occurred: {0}",
		"ハンドルされない例外が発生しました。",
		"ユーザーによりハンドルされない例外が発生しました。",
	...
	"vs/workbench/parts/explorers/browser/treeExplorer.contribution": [
		"カスタム Tree Explorer Viewlet をサイドバーに追加します",
		"vscode.workspace.registerTreeExplorerNodeProvider を介して登録したプロバイダーを識別するための一意の ID",
		"カスタム Tree Explorer の表示に使用される、人が判別できる文字列",
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"アプリケーションが閉じると (Windows/Linux で最後のウィンドウが閉じるとき、または workbench.action.quit コマンドがトリガーするとき (コマンド パレット、キー バインド、メニュー))、Hot Exit がトリガーされます。また、フォルダーが開かれているウィンドウについても、それが最後のウィンドウかどうかに関係なく、Hot Exit がトリガーされます。フォルダーが開かれていないウィンドウはすべて、次回の起動時に復元されます。フォルダーのウィンドウをシャットダウン前と同じ状態に復元するには、\"window.reopenFolders\" を \"all\" に設定します。",
	...
	"vs/workbench/parts/git/browser/views/gitless/gitlessView": [
		...
		"Git をインストールし終えたら、VSCode を再起動してください。",
	],
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"タスクは既にアクティブおよびウォッチ モードになっています。タスクを終了するには、`F1 > タスクの終了` を使用します",
	...
	"vs/workbench/parts/terminal/electron-browser/terminalConfigHelper": [
		"このワークスペースでは、ターミナル シェルをカスタマイズしようとしています。許可しますか? ({0})",
		"許可",
		"キャンセル",
		"許可しない",
	],
	...
	"vs/workbench/parts/welcome/page/electron-browser/vs_code_welcome_page": [
		...
		"キーボード ショートカットの参照資料",
		"最も一般的なキーボード ショートカットを掲載した印刷可能な PDF です",
		"すべてのコマンドの検索と実行",
		"コントロール パネルからコマンドを検索してすばやくアクセスします ({0})",
		"設定を構成する",
		"VS Code の全機能を活用するために設定を微調整します",
		"キーボード ショートカットをインストールします",
		"{0}、{1}、{2}、{3} のキーボード ショートカットをインストール",
		"Vim",
		"Vim",
		"Vim (最新)",
		"Sublime",
	...
	"vs/workbench/services/textfile/electron-browser/textFileService": [
		...
		"保存しないと変更内容が失われます。",
		"既定では Hot Exit が有効です",
		"Hot Exit はセッション間で保存されていないファイルの内容を保持するため、終了前にファイルを保存する必要はありません。\'files.hotExit\' 設定を使用すると、この機能を無効にできます。",
		"OK",
		"すべてのファイル",
		"拡張子なし",
	],
	"vs/workbench/services/themes/common/colorThemeSchema": [
		"構文の強調表示をする色",
		"ルールの説明",
		"ルールのフォント スタイル: \'斜体\'、\'太字\'、\'下線\' のいずれかまたはこれらの組み合わせ",
	],
	...
	"vs/workbench/services/themes/electron-browser/colorThemeData": [
		...
		"JSON テーマ ファイルの解析中に問題が発生しました: {0}。\'tokenColors\' と \'colors\' が必要です。",
		"テーマ ファイルの解析中に問題が発生しました: {0}. \'settings\' は配列ではありません。",
		"テーマ ファイルの解析中に問題が発生しました: {0}",
		"テーマ ファイル {0} の読み込み中に問題が発生しました: {1}",
	],
	"vs/workbench/services/themes/electron-browser/workbenchThemeService": [
		...
		"ファイル アイコンがありません",
		"ファイル アイコンのテーマが不明、またはインストールされていません。",
