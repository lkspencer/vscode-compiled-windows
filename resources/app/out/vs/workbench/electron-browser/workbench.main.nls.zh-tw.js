...
define("vs/workbench/electron-browser/workbench.main.nls.zh-tw", {
	...
	"vs/platform/theme/common/colorRegistry": [
		...
		"作業區域選取的背景顏色(例如輸入或文字區域)。請注意，這不適用於編輯器與終端機中的選取。",
		"文字分隔符號的顏色。",
		"內文連結的前景色彩",
		"內文使用連結的前景色彩",
		"提示及建議文字的前景色彩。",
	...
	"vs/workbench/parts/emmet/electron-browser/emmet.contribution": [
		...
		"試試所有 Emmet 功能的新 Emmet 模組 (最終會取代舊的單一 Emmet 程式庫)。",
	],
	...
	"vs/workbench/parts/tasks/electron-browser/jsonSchema_v2": [
		...
		"此工作相依的其他工作。",
		"請描述如何使用終端機以執行工作行為。",
		"控制是否將執行的命令傳到終端機。預設為 False。",
		"控制是否顯示執行工作的終端機。預設為「永遠」。",
		"請定義此工作所屬的執行群組。若是省略此步驟，工作會屬於沒有群組。",
