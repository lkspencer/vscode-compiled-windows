...
define("vs/workbench/electron-browser/workbench.main.nls.zh-tw", {
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"控制編輯器的索引標籤關閉按鈕位置，或在設為 [關閉] 時將其停用。",
		...
		"控制開啟新視窗的維度。根據預設，新視窗會以小型維度在畫面中央開啟。設為 [繼承] 時，視窗的維度會和上一個使用中視窗相同。設為 [最大化] 時，視窗會開到最大，若設為 [全螢幕] 則全螢幕開啟。",
	...
	"vs/workbench/parts/preferences/browser/preferencesEditor": [
		...
		"在設定中取代",
		"複製到設定",
		"這項設定必須是使用者設定。若要設定工作區的 TypeScript，請開啟 TypeScript 檔案並按一下狀態列中的 TypeScript 版本。",
	...
	"vs/workbench/parts/tasks/electron-browser/terminalTaskSystem": [
		"tasks.json 中未定義任何組建工作",
		"tasks.json 中未定義任何測試工作",
		"找不到工作 \'{0}\'",
	...
	"vs/workbench/parts/tasks/node/processRunnerConfiguration": [
		...
		"工作 {0} 是殼層命令，會指定引數。為了確保引述正確的命令列，請將引數併入命令中。",
	],
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"控制終端機資料指標的樣式。",
		"控制終端機保留在其緩衝區中的行數上限。",
		"控制終端機模擬器是否將使用流量控制以趕上殼層處理，這樣做的主要影響是當命令產生許多輸出時，^C 和其他訊號的反應會更快。如果您有覆寫所使用之 XOFF 和 XON 訊號的自訂 ^S 或 ^Q 按鍵繫結關係，則應該停用此設定。",
	...
	"vs/workbench/services/themes/electron-browser/themeService": [
		...
		"剖析 JSON theme 檔案 {0} 時出現問題。\'settings\' 不是陣列。",
		"剖析 theme 檔案 {0} 時出現問題。\'settings\' 不是陣列。",
		"剖析 theme 檔案時發生問題: {0}",
