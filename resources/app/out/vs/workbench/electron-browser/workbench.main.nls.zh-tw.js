...
define("vs/workbench/electron-browser/workbench.main.nls.zh-tw", {
	...
	"vs/editor/common/view/editorColorRegistry": [
		"編輯器行的反白顯示色彩",
		"編輯器行醒目提示框線方塊的色彩",
		"反白顯示之範圍的背景色彩，例如由 Quick Open 與尋找功能反白顯示的區域",
		"編輯器游標色彩",
	...
	"vs/workbench/common/theme": [
		"索引標籤容器的背景色彩。索引標籤是編輯器在編輯器區域中的容器。同一個編輯器群組中的多個索引標籤可以同時開啟。可能會有多個編輯器群組。",
		...
		"編輯器群組的背景色彩。編輯器群組是編輯器的容器。",
		"拖曳編輯器時的背景色彩。",
		"用以分隔詳細資料與並排編輯器之主要排的框線色彩。",
		...
		"狀態列資訊項目的背景色彩。狀態列會顯示在視窗的底部",
		"動態顯示時，狀態列資訊項目的背景色彩。狀態列會顯示在視窗的底部",
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"Hot Exit 將會在關閉應用程式時觸發，也就是在 Windows/Linux 上關閉上一個視窗，或是觸發 workbench.action.quit 命令 (命令選擇區、按鍵繫結關係、功能表) 時觸發，也會針對已開啟資料夾的任何視窗觸發，而不論其是否為上一個視窗。具有備份的所有視窗都會在下次啟動時還原。若要將資料夾視窗還原成關機前的狀態，請將 \"window.reopenFolders\" 設定為 \"all\"。",
	...
	"vs/workbench/parts/tasks/common/taskConfiguration": [
		...
		"錯誤: 工作 \'{0}\' 未指定命令或 dependsOn 屬性。即將略過該工作。其定義為:\n{1}",
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"找不到所要求要執行的工作 {0}。",
		"工作已在使用中並處於監看模式。若要終止工作，請使用 F1 > [終止工作]",
	...
	"vs/workbench/parts/welcome/page/electron-browser/vs_code_welcome_page": [
		...
		"將編輯器及您的程式碼設定成您喜愛的外觀",
		"鍵盤快速鍵參考",
		"可列印的 PDF，附有最常用的鍵盤快速鍵",
		"尋找並執行所有命令",
		"從控制台快速存取及搜尋命令 ({0})",
		"組態設定",
		"微調設定就能發揮 VS Code 的所有功能",
		"安裝鍵盤快速鍵",
		"安裝鍵盤快速鍵 {0}、{1}、{2} 及 {3}",
		"活力",
		"活力",
	...
	"vs/workbench/services/textfile/electron-browser/textFileService": [
		...
		"如果您不儲存變更，這些變更將會遺失。",
		"現在預設啟動 Hot Exit",
		"Hot Exit 會記住任何工作階段間未儲存的檔案，您無須先儲存您的檔案再結束。您可以使用 \'files.hotExit\' 設定停用此功能。",
		"確定",
		"所有檔案",
		"無擴充功能",
	],
	...
	"vs/workbench/services/themes/electron-browser/colorThemeData": [
		...
		"剖析 JSON 佈景主題檔案時發生問題: {0}。應為 \'tokenColors\' 及 \'colors\'。",
		"剖析佈景主題檔案 {0} 時出現問題。\'settings\' 不是陣列。",
		"剖析佈景主題檔案 {0} 時發生問題",
		"載入佈景主題檔案 {0} 時發生問題: {1}",
	],
	"vs/workbench/services/themes/electron-browser/workbenchThemeService": [
		...
		"無法載入 {0}",
		"剖析檔案的圖示檔時發生問題: {0}",
		"指定 Workbench 中使用的色彩佈景主題。",
		"佈景主題未知或未安裝。",
		"指定 Workbench 中使用的圖示佈景主題。",
		"沒有檔案圖示",
		"檔案圖示佈景主題未知或未安裝。",
