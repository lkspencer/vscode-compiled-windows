...
define("vs/workbench/electron-browser/workbench.main.nls.ru", {
	...
	"vs/workbench/common/theme": [
		...
		"Цвет обратной связи при перетаскивании для элементов панели действий. Панель действий отображается слева или справа и позволяет переключаться между представлениями боковой панели.",
	...
	"vs/workbench/parts/git/node/git.lib": [
		"Невозможно открыть файл из GIT.",
	...
	"vs/workbench/parts/tasks/browser/restartQuickOpen": [
		"{0}, задачи",
		"Введите имя задачи для перезапуска",
	...
	"vs/workbench/services/themes/electron-browser/workbenchThemeService": [
		...
		"Переопределяет цвета из выбранной цветовой темы. Это экспериментальный параметр, так как имена цветов изменятся в следующем выпуске.",
