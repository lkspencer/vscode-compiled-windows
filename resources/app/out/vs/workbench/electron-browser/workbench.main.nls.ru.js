...
define("vs/workbench/electron-browser/workbench.main.nls.ru", {
	...
	"vs/editor/contrib/inspectTMScopes/electron-browser/inspectTMScopes": [
		"Developer: проверка областей TM",
		"Загрузка...",
	],
	...
	"vs/workbench/browser/parts/editor/editorStatus": [
		...
		"({0})",
		"языки (идентификатор)",
		"Настройка языковых параметров \"{0}\"...",
	...
	"vs/workbench/parts/output/browser/outputActions": [
		...
		"Очистить выходные данные",
		"Включить/отключить вывод SCROLL LOCK",
	...
	"vs/workbench/parts/preferences/browser/preferencesEditor": [
		...
		"Этот параметр должен быть параметром пользователя. Чтобы настроить в рабочей области TypeScript, откройте файл TypeScript и щелкните его версию в строке состояния.",
	...
	"vs/workbench/parts/scm/browser/scmViewlet": [
		"Зафиксировать",
		"Сообщение (нажмите {0} для отправки)",
		"Изменения: введите сообщение и нажмите клавишу {0} для принятия изменений",
	],
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"Задачи выполняются в интегрированном терминале. Используйте его для управления задачами.",
	...
	"vs/workbench/parts/tasks/electron-browser/terminalTaskSystem": [
		"Не определены задачи сборки в tasks.json",
		"Не определены задачи тестирования в tasks.json.",
		"Задача \"{0}\" не найдена.",
	...
	"vs/workbench/parts/tasks/node/processRunnerConfiguration": [
		...
		"Задача {0} — это команда оболочки, которая указывает аргументы. Чтобы кавычки в командной строке были расставлены правильно, объедините аргументы с командой.",
	],
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"Определяет, будет ли эмулятор терминала использовать управление потоком, чтобы сократить разрыв с оболочкой. Основной эффект: ^C и другие сигналы должны быть более быстрыми, если команда выдает значительный объем выходных данных. Этот параметр следует отключить, если у вас настраиваемые сочетания клавиш ^S или ^Q, переопределяющие сигналы XOFF и XON.",
	...
	"vs/workbench/parts/welcomePage/electron-browser/welcomePage.contribution": [
		"Рабочее место",
		"Если включено, при запуске будет отображаться интерфейс приветствия.",
		"Справка",
	],
	...
	"vs/workbench/services/themes/electron-browser/themeService": [
		...
		"Ошибка при анализе файла темы JSON: {0}. settings не является массивом.",
		"Ошибка при анализе файла темы: {0}. settings не является массивом.",
		"Ошибка при анализе файла темы: {0}",
