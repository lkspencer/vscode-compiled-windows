...
define("vs/workbench/electron-browser/workbench.main.nls.ru", {
	...
	"vs/editor/common/view/editorColorRegistry": [
		"Цвет выделения строк в редакторе",
		"Цвет выделения полей границ в строках редактора",
		"Цвет фона для выбранного диапазона, например, при использовании функций Quick Open и поиска",
		"Цвет курсора редактора",
		"Color of whitespace characters in the editor.",
		"Color of the editor indentation guides.",
		"Номера строк редактора",
	],
	...
	"vs/editor/contrib/wordHighlighter/common/wordHighlighter": [
		"Цвет фона символа при доступе на чтение, таком как считывание переменной",
		"Цвет фона символа при доступе на запись, таком как запись переменной",
	],
	...
	"vs/platform/markers/common/problemMatcher": [
		...
		"Ошибка: в описании не задан допустимый шаблон проблем:\n{0}\n",
		...
		"Шаблоны для отслеживания начала и окончания шаблона просмотра.",
	...
	"vs/platform/theme/common/colorRegistry": [
		...
		"Цвет для выбранной области редактора",
		"Цвет для неактивной выбранной области редактора",
		"Color for regions with the same content as the selection.",
		"Color of the current search match.",
		"Цвет фона областей, соответствующих поиску",
		"Цвет фона областей, выбранных для поиска",
		"Цвет активных ссылок",
		"Цвет ссылок",
		"Фон мини-приложения поиска",
	],
	...
	"vs/workbench/common/theme": [
		"Цвет фона контейнера вкладок. Вкладки — это контейнеры для редакторов в области редакторов. В одной группе редакторов можно открыть несколько вкладок. Может быть несколько групп редакторов.",
		...
		"Цвет фона в группе редакторов. Группы редакторов — это контейнеры редакторов.",
		"Цвет фона при перетаскивании редакторов.",
		"Цвет границ для отделения сведений от эталонной боковой панели для параллельных редакторов.",
		...
		"Цвет переднего плана панели состояния. Панель состояния показана внизу окна.",
		"Цвет фона стандартной панели состояния. Панель состояния показана внизу окна.",
		"Цвет фона панели состояния, если папка не открыта. Панель состояния показана внизу окна.",
		...
		"Цвет фона элементов со сведениями о панели состояния. Панель состояния отображается внизу окна",
		"Цвет фона элементов со сведениями о панели состояния при наведении указателя. Панель состояния отображается внизу окна",
	...
	"vs/workbench/electron-browser/actions": [
		...
		"Перейти к части представления слева",
		"Перейти к части представления справа",
		"Перейти к части представления вверху",
		"Перейти к части представления внизу",
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"Запрет повторного открытия папки.",
		"Повторное открытие последней активной папки.",
		"Повторное открытие всех папок последнего сеанса.",
	...
	"vs/workbench/parts/debug/browser/exceptionWidget": [
		"Цвет границ мини-приложения исключения",
		"Цвет фона мини-приложения исключения",
		"Произошло исключение, обработанное пользователем.",
		"Возникло всегда критическое исключение.",
		"Произошло необработанное исключение.",
		"Произошло исключение, не обработанное пользователем.",
	...
	"vs/workbench/parts/emmet/node/emmet.contribution": [
		...
		"Путь к папке, содержащей профили Emmet, фрагменты кода и настройки",
	],
	...
	"vs/workbench/parts/explorers/browser/treeExplorer.contribution": [
		"Добавляет в боковую панель настраиваемое мини-приложение обозревателя дерева",
		...
		"Понятная для пользователей строка, используемая для отображения настраиваемого обозревателя дерева",
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"\"Горячий\" выход будет активирован при закрытии приложения, то есть когда закрывается последнее окно в Windows или Linux или при активации команды workbench.action.quit (палитра команд, настраиваемое сочетание клавиш, меню). Все окна с резервными копиями будут восстановлены при следующем запуске.",
		"\"Горячий\" выход будет активирован при закрытии приложения, то есть когда закрывается последнее окно в Windows или Linux или при активации команды workbench.action.quit (палитра команд, настраиваемое сочетание клавиш, меню) и в любых окнах, где открыта папка, даже если это не последнее окно. Окна без открытых папок будут восстановлены при следующем запуске. Чтобы восстановить окна с папками, перед завершением работы задайте для \"window.reopenFolders\" значение \"all\".",
	...
	"vs/workbench/parts/files/browser/saveErrorHandler": [
		...
		"Сравнить",
		"{0} (на диске) ↔ в {1} (в {2}) — разрешение конфликта сохранения",
	...
	"vs/workbench/parts/git/browser/gitActions": [
		...
		"Зафиксировать промежуточные (изменение)",
	...
	"vs/workbench/parts/git/browser/gitActions.contribution": [
		...
		"Действительно отменить выбранные изменения?",
		"Это действие необратимо.",
		"&&Отменить изменения",
		"Открыть изменение",
		"Открыть файл",
	...
	"vs/workbench/parts/git/browser/gitWorkbenchContributions": [
		...
		"Определяет, какие типы ветвей вносятся в список.",
	],
	...
	"vs/workbench/parts/git/browser/views/gitless/gitlessView": [
		...
		"После установки GIT перезапустите VSCode.",
	],
	...
	"vs/workbench/parts/preferences/browser/keybindingsEditor": [
		...
		"Change Keybinding",
		"Add Keybinding",
		"Удалить настраиваемое сочетание клавиш",
	...
	"vs/workbench/parts/scm/electron-browser/scmViewlet": [
		"Сообщение (чтобы зафиксировать, нажмите кнопку {0})",
		"Source Control",
		"{0}: {1}",
	],
	...
	"vs/workbench/parts/tasks/browser/terminateQuickOpen": [
		"Введите имя задачи для завершения",
		"Нет соответствующих задач",
		"Не найдены задачи для завершения",
	],
	"vs/workbench/parts/tasks/common/taskConfiguration": [
		...
		"Ошибка: задача \"{0}\" не задает команду или свойство dependsOn. Задача будет игнорироваться. Ее определение: \n{1}",
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"Следует ли разрешить полужирный текст в терминале.",
	...
	"vs/workbench/parts/terminal/electron-browser/terminalConfigHelper": [
		"Эта рабочая область запрашивает настройку оболочки терминала. Разрешить? ({0})",
		"Разрешить",
		"Отмена",
		"Запретить",
	],
	...
	"vs/workbench/parts/welcome/page/electron-browser/vs_code_welcome_page": [
		...
		"Справочник по сочетаниям клавиш",
		"Подготовленный к печати PDF-файл с самыми частыми сочетаниями клавиш",
		"Найти и выполнить все команды",
		"Быстрый доступ и поиск команд на панели управления ({0})",
		"Настройка параметров",
		"Используйте все возможности VS Code, подобрав нужные параметры.",
		"Установка сочетаний клавиш",
		"Установите сочетания клавиш {0}, {1}, {2} и {3}.",
		"Vim",
		"Vim",
		"Vim (текущий)",
		"Sublime",
	...
	"vs/workbench/parts/welcome/page/electron-browser/welcomePage.contribution": [
		"Рабочее место",
		"Если этот параметр включен, страница приветствия будет отображаться при запуске.",
		"Справка",
	],
	...
	"vs/workbench/services/textfile/electron-browser/textFileService": [
		...
		"Отмена",
		"Если не сохранить изменения, они будут утеряны.",
		"Функция \"Горячий выход\" включена по умолчанию.",
		"Функция \"Горячий выход\" запоминает все несохраненные файлы между сеансами, поэтому нет необходимости сохранять файлы перед выходом. Эту функцию можно отключить с помощью параметра files.hotExit.",
		"ОК",
		"Все файлы",
		"Нет расширений",
	],
	...
	"vs/workbench/services/themes/electron-browser/colorThemeData": [
		...
		"Проблемы при анализе файла темы JSON: {0}. Ожидаются \"tokenColors\" и \"colors\".",
		"Ошибка при анализе файла темы: {0}. settings не является массивом.",
		"Ошибки при анализе файла темы: {0}",
		"Проблемы при загрузке файла темы {0}: {1}",
	],
	"vs/workbench/services/themes/electron-browser/workbenchThemeService": [
		...
		"Задает цвет темы рабочего места.",
		"Тема неизвестна или не установлена.",
		"Задает тему значка, используемого в рабочем месте.",
		"Нет значков файлов.",
		"Тема значка файла неизвестна или не установлена.",
