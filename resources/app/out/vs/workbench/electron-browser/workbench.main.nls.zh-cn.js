...
define("vs/workbench/electron-browser/workbench.main.nls.zh-cn", {
	...
	"vs/workbench/common/theme": [
		"选项卡容器的边框颜色。选项卡是编辑器区域中编辑器的容器。可在一个编辑器组中打开多个选项卡。可以存在多个编辑器组。",
		...
		"编辑器组的背景色。编辑器组是编辑器的容器。",
		"随意拖动编辑器时的背景色。",
		"用于将并排编辑器的详细信息与主边栏分隔开的边框颜色。",
		...
		"状态栏前景色。状态栏显示在窗口底部",
		"标准状态栏背景色。状态栏显示在窗口底部",
		"没有文件打开时状态栏的背景色。状态栏显示在窗口底部",
		"单击时的状态栏项背景色。状态栏显示在窗口的底部",
		"悬停时的状态栏项背景色。状态栏显示在窗口的底部",
		"状态栏信息项背景色。状态栏显示在窗口的底部",
		"悬停时的状态栏信息项背景色。状态栏显示在窗口的底部",
	...
	"vs/workbench/services/themes/electron-browser/colorThemeData": [
		...
		"分析 JSON 主题文件时出现问题: {0}。需要“令牌颜色”和“颜色”。",
