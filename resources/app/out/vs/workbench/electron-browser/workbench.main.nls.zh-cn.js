...
define("vs/workbench/electron-browser/workbench.main.nls.zh-cn", {
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"工作台",
		"控制打开的编辑器是否显示在选项卡中。",
		"控制编辑器的选项卡关闭按钮的位置，或当设置为“关闭”时禁用关闭它们。",
	...
	"vs/workbench/parts/preferences/browser/preferencesEditor": [
		...
		"在设置中替换",
		"复制到设置",
		"此设置必须是“用户设置”。若要为工作区配置 TypeScript，请打开 TypeScript 文件并单击状态栏中的“TypeScript 版本”。",
	...
	"vs/workbench/parts/tasks/node/processRunnerConfiguration": [
		...
		"任务 {0} 是 shell 命令且指定参数。若要确保命令行引用正确，请将参数合并到命令中。",
	],
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"控制终端游标的样式。",
		"控制终端保持在缓冲区的最大行数。",
		"确定终端仿真器是否使用流控制以便赶上 shell 进程，此操作的主要作用是: 当命令产生大量输出时，^C 和其他信号应响应更敏捷。如果使用替代 XOFF 和 XON 信号的自定义 ^S 或 ^Q 键绑定，则应禁用此操作。",
	...
	"vs/workbench/services/themes/electron-browser/themeService": [
		...
		"分析 JSON 主题文件 {0} 时出现问题。“设置”不是数组。",
		"分析主题文件 {0} 时出现问题。“设置”不是数组。",
		"分析主题文件 {0} 时出现问题",
