...
define("vs/workbench/electron-browser/workbench.main.nls.ko", {
	...
	"vs/platform/theme/common/colorRegistry": [
		...
		"워크벤치의 텍스트 선택(예: 입력 필드 또는 텍스트 영역) 전경색입니다. 편집기와 터미널 내의 선택에는 적용되지 않습니다.",
		"텍스트 구분자 색상입니다.",
		"텍스트 내 링크의 전경색입니다.",
		"텍스트 내 활성 링크의 전경색입니다.",
	...
	"vs/workbench/parts/emmet/electron-browser/emmet.contribution": [
		...
		"모든 emmet 기능에 대해 새 emmet 모듈을 사용해 보세요(이전 단일 emmet 라이브러리를 대체함).",
	],
	...
	"vs/workbench/parts/tasks/electron-browser/jsonSchema_v2": [
		...
		"작업을 실행하는 데 사용되는 터미널이 동작하는 방식을 설명합니다.",
		"실행된 명령을 터미널에 에코할지 여부를 제어합니다. 기본값은 false입니다.",
		"작업을 실행 중인 터미널이 표시되는지 여부를 제어합니다. 기본값은 \"항상\"입니다.",
		"이 작업이 속한 실행 그룹을 정의합니다. 생략하면 작업은\n 아무 그룹에도 속하지 않습니다.",
	...
	"vs/workbench/services/configuration/node/configurationEditingService": [
		...
		"폴더가 열려 있지 않으므로 설정에 쓸 수 없습니다. 먼저 폴더를 열고 다시 시도하세요.",
