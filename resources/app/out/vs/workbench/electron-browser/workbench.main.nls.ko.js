...
define("vs/workbench/electron-browser/workbench.main.nls.ko", {
	...
	"vs/editor/common/view/editorColorRegistry": [
		"편집기 줄 강조 표시 색",
		"편집기 줄 강조 표시 테두리 상자 색",
		"빠른 열기 및 찾기 기능 등을 통해 강조 표시된 영역의 배경색",
		"편집기 커서 색",
	...
	"vs/editor/contrib/wordHighlighter/common/wordHighlighter": [
		"변수 읽기와 같은 읽기 액세스 중 기호의 배경색",
		"변수에 쓰기와 같은 쓰기 액세스 중 기호의 배경색",
	],
	...
	"vs/workbench/common/theme": [
		"탭 컨테이너의 배경색입니다. 탭은 편집기 영역에서 편집기의 컨테이너입니다. 한 편집기 그룹에 여러 탭을 열 수 있습니다. 여러 편집기 그룹이 있을 수 있습니다.",
		...
		"편집기 그룹의 배경색입니다. 편집기 그룹은 편집기의 컨테이너입니다.",
		"편집기를 끌어올 때의 배경색입니다.",
		"병렬 편집기에서 마스터 쪽의 세부 정보를 구분하기 위한 테두리 색입니다.",
		...
		"상태 표시줄 정보 항목 배경색입니다. 상태 표시줄은 창의 맨 아래에 표시됩니다.",
		"마우스로 가리킬 때의 상태 표시줄 정보 항목 배경색입니다. 상태 표시줄은 창의 맨 아래에 표시됩니다.",
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"최대화된 새 창을 엽니다.",
		"전체 화면 모드에서 새 창을 엽니다.",
		"새 창을 열 때 크기를 제어합니다. 기본적으로 새 창은 화면 가운데에 작은 크기로 열립니다. \'inherit\'으로 설정할 경우 마지막 활성 창과 동일한 크기로 창이 열립니다. \'maximized\'로 설정할 경우 창이 최대화되어 열리고 \'fullscreen\'으로 구성할 경우 전체 화면으로 열립니다.",
	...
	"vs/workbench/parts/emmet/node/emmet.contribution": [
		...
		"Emmet 프로필, 코드 조각 및 기본 설정이 포함된 폴더의 경로",
	],
	...
	"vs/workbench/parts/explorers/browser/treeExplorer.contribution": [
		"사이드바에 사용자 지정 Tree Explorer 뷰렛을 적용합니다.",
		"vscode.workspace.registerTreeExplorerNodeProvider를 통해 등록된 공급자를 식별하는 데 사용된 고유 ID",
		"사용자 지정 Tree Explorer를 렌더링하는 데 사용되는 사람이 읽을 수 있는 문자열",
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"핫 종료는 응용 프로그램을 닫을 때 트리거됩니다. 즉 Windows/Linux에서 마지막 창을 닫을 때나 workbench.action.quit 명령이 트리거될 때(명령 팔레트, 키 바인딩, 메뉴), 또한 마지막 창인지 여부에 상관없이 폴더가 열린 모든 창의 경우입니다. 열린 폴더가 없는 모든 창은 다음 실행 시 복원됩니다. 종료되기 전에 폴더 창을 복원하려면 \"window.reopenFolders\"를 \"all\"로 설정합니다.",
	...
	"vs/workbench/parts/tasks/common/taskConfiguration": [
		...
		"오류: 작업 \'{0}\'에서 명령이나 dependsOn 속성을 지정하지 않습니다. 이 작업은 무시됩니다. 해당 작업의 정의는 \n{1}입니다.",
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"99+",
		"작업",
		"작업 실행 엔진을 변경하면 VS Code를 다시 시작해야 합니다. 변경이 무시됩니다.",
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"터미널 내에서 굵은 텍스트를 사용하도록 설정할지 여부입니다.",
	...
	"vs/workbench/parts/terminal/electron-browser/terminalConfigHelper": [
		"이 작업 영역에서 터미널 셸을 사용자 지정하려고 합니다. 허용하시겠습니까? ({0})",
		"허용",
		"취소",
		"허용 안 함",
	],
	...
	"vs/workbench/parts/welcome/page/electron-browser/vs_code_welcome_page": [
		...
		"바로 가기 키 참조",
		"가장 일반적인 바로 가기 키가 포함된 인쇄 가능한 PDF",
		"모든 명령 찾기 및 실행",
		"제어판에서 명령을 빠르게 검색 및 액세스({0})",
		"설정 구성",
		"설정을 조정하여 VS Code 의 전체 기능 잠금 해제",
		"바로 가기 키 설치",
		"{0}, {1}, {2} 및 {3}의 바로 가기 키 설치",
		"Vim",
		"Vim",
		"Vim(현재)",
		"Sublime",
	...
	"vs/workbench/parts/welcome/page/electron-browser/welcomePage.contribution": [
		"워크벤치",
		"사용하도록 설정되면 시작할 때 시작 페이지를 표시합니다.",
		"도움말",
	],
	...
	"vs/workbench/services/textfile/electron-browser/textFileService": [
		...
		"취소",
		"변경 내용을 저장하지 않은 경우 변경 내용이 손실됩니다.",
		"이제 Hot Exit을 기본적으로 사용합니다.",
		"Hot Exit에서는 세션 간에 저장하지 않은 파일을 기억하므로 세션 간에 끝내기 전에 파일을 저장할 필요가 없습니다. \'files.hotExit\' 설정을 사용하여 이 기능을 사용하지 않도록 설정할 수 있습니다.",
		"확인",
		"모든 파일",
		"확장 없음",
	],
	"vs/workbench/services/themes/common/colorThemeSchema": [
		"구문 강조 표시를 위한 색",
		"규칙에 대한 설명",
		"규칙의 글꼴 스타일: \'기울임꼴, \'굵게\' 및 \'밑줄\' 중 하나 또는 이들의 조합",
	],
	...
	"vs/workbench/services/themes/electron-browser/colorThemeData": [
		...
		"JSON 테마 파일을 구문 분석하는 중 문제 발생: {0}. \'tokenColors\' 및 \'colors\'가 필요합니다.",
		"테마 파일({0})을 구문 분석하는 중 문제가 발생했습니다. \'settings\'가 배열이 아닙니다.",
		"테마 파일({0})을 구문 분석하는 중 문제가 발생했습니다.",
		"테마 파일 {0}을(를) 로드하는 중 문제 발생: {1}",
	],
	"vs/workbench/services/themes/electron-browser/workbenchThemeService": [
		...
		"워크벤치에서 사용되는 색 테마를 지정합니다.",
		"테마를 알 수 없거나 설치되지 않았습니다.",
		"워크벤치에서 사용되는 아이콘 테마를 지정합니다.",
		"파일 아이콘이 없습니다.",
		"파일 아이콘 테마를 알 수 없거나 설치되지 않았습니다.",
