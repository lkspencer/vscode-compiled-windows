...
define("vs/workbench/electron-browser/workbench.main.nls.ko", {
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"편집기의 탭 닫기 단추의 위치를 제어하거나 \'끔\'으로 설정된 경우 이 단추를 사용하지 않도록 설정합니다.",
		...
		"새 창을 열 때 크기를 제어합니다. 기본적으로 새 창은 화면 가운데에 작은 크기로 열립니다. \'상속\'으로 설정할 경우 마지막 활성 창과 동일한 크기로 창이 열립니다. \'최대화\'로 설정할 경우 창이 최대화되어 열리고 \'전체 화면\'으로 구성할 경우 전체 화면으로 열립니다.",
		"메뉴 모음의 표시 여부를 제어합니다. \'설정/해제\'를 설정함으로써 메뉴 모음이 숨겨지고 <Alt> 키를 누를 때마다 메뉴 모음이 표시됩니다. 기본값으로, 창이 전체 화면이 아닌 이상 메뉴 모음이 표시됩니다.",
	...
	"vs/workbench/parts/cli/electron-browser/cli.contribution": [
		...
		"Code에서 \'{0}\' 셸 명령을 변경해야 합니다. 지금 변경할까요?",
		"지금 변경",
		"나중에",
	...
	"vs/workbench/parts/preferences/browser/preferencesEditor": [
		...
		"설정에서 바꾸기",
		"설정에 복사",
		"이 설정은 사용자 설정이어야 합니다. 작업 영역에 대해 TypeScript를 구성하려면 TypeScript 파일을 열고 상태 표시줄에서 TypeScript 버전을 클릭합니다.",
	...
	"vs/workbench/parts/scm/browser/scmViewlet": [
		"커밋",
		"메시지(제출하려면 {0} 누르기)",
		"변경 내용: 변경 내용을 적용하려면 메시지를 입력하고 {0}을(를) 누르세요.",
	],
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"터미널 보기",
		"실행 중인 작업 종료",
		"작업은 통합 터미널에서 실행됩니다. 터미널을 사용하여 작업을 관리하세요.",
	...
	"vs/workbench/parts/tasks/electron-browser/terminalTaskSystem": [
		"tasks.json에 정의된 빌드 작업이 없습니다.",
		"tasks.json에 정의된 테스트 작업이 없습니다.",
		"\'{0}\' 작업을 찾을 수 없습니다.",
	...
	"vs/workbench/parts/tasks/node/processRunnerConfiguration": [
		...
		"작업 {0}은(는) 셸 명령이며 인수를 지정합니다. 올바른 명령줄 인용인지 확인하려면 인수를 명령으로 병합하세요.",
	],
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"터미널 에뮬레이터에서 셸 프로세스를 따라잡기 위해 흐름 제어를 사용할지 여부를 제어합니다. 명령이 많은 출력을 제공할 때 ^C 및 기타 신호의 응답성이 향상되는 효과가 있습니다. 사용되는 XOFF 및 XON 신호를 재정의하는 사용자 지정 ^S 또는 ^Q 키 바인딩이 있는 경우 이 기능을 사용하지 않도록 설정해야 합니다.",
	...
	"vs/workbench/parts/welcomePage/electron-browser/welcomePage.contribution": [
		"워크벤치",
		"사용하도록 설정하는 경우 시작 시 시작 환경이 표시됩니다.",
		"도움말",
	],
	...
	"vs/workbench/services/themes/electron-browser/themeService": [
		...
		"JSON 테마 파일 {0}을(를) 구문 분석하는 중 문제가 발생했습니다. \'settings\'가 배열이 아닙니다.",
		"테마 파일을 구문 분석하는 중 문제 발생: {0}. \'settings\'가 배열이 아닙니다.",
		"테마 파일을 구문 분석하는 중 문제 발생: {0}",
