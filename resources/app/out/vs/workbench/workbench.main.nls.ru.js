...
define("vs/workbench/workbench.main.nls.ru", {
	...
	"vs/workbench/parts/debug/electron-browser/debug.contribution": [
		...
		"Просмотреть",
		"Отладка",
		"Конфигурация запуска \"{0}\" не существует.",
		"Ошибка при отладке",
	],
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsActions": [
		...
		"Обновить",
		"Включить",
		"Чтобы включить это расширение, необходимо перезапустить это окно VS Code.\n\nПродолжить?",
		"Перезагрузка",
		...
		"Настроить рекомендуемые расширения рабочей области",
	...
	"vs/workbench/parts/git/browser/gitActions": [
		...
		"Сбой аутентификации для команды git remote.",
		"Вы действительно хотите синхронизировать репозиторий Git?",
		"Сбой аутентификации для команды git remote.",
	...
	"vs/workbench/parts/update/electron-browser/update.contribution": [
		...
		"Прочитать лицензию",
		"Сборки для участников программы становятся ежедневными.",
		"Подробнее",
		"Больше не показывать",
		"Заметки о выпуске",
	],
