 ...
 *--------------------------------------------------------*/
(function() {
var __m = ["require","exports","vs/base/common/winjs.base","vs/base/common/types","vs/base/common/platform","vs/base/common/event","vs/base/common/strings","vs/base/common/errors","vs/base/common/lifecycle","vs/base/common/paths","vs/base/common/objects","vs/base/common/uri","vs/base/common/functional","vs/base/common/arrays","vs/base/common/mime","vs/base/common/map","child_process","vs/base/node/stream","vs/base/node/encoding","vs/base/common/async","vs/base/common/glob","vs/base/common/callbackList","vs/base/node/decoder","vs/workbench/services/search/node/worker/searchWorker","vs/base/node/event","vs/base/node/stdFork","path","vs/base/parts/ipc/node/ipc.cp","vs/base/node/processes","vs/workbench/services/search/node/worker/searchWorkerIpc","vs/base/common/parsers","fs","vs/base/common/cancellation","vs/nls!vs/base/node/processes","vs/base/common/processes","vs/base/node/mime","vs/base/parts/ipc/common/ipc","vs/nls!vs/base/common/processes","vs/nls","vs/nls!vs/workbench/services/search/node/worker/searchWorkerApp","jschardet","iconv-lite","net","stream","os","string_decoder","graceful-fs","vs/base/common/winjs.base.raw","vs/workbench/services/search/node/worker/searchWorkerApp"];
...
define(__m[30/*vs/base/common/parsers*/], __M([0/*require*/,1/*exports*/,3/*vs/base/common/types*/]), function (require, exports, Types) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[11/*vs/base/common/uri*/], __M([0/*require*/,1/*exports*/,4/*vs/base/common/platform*/]), function (require, exports, platform) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[5/*vs/base/common/event*/], __M([0/*require*/,1/*exports*/,8/*vs/base/common/lifecycle*/,21/*vs/base/common/callbackList*/,2/*vs/base/common/winjs.base*/,12/*vs/base/common/functional*/]), function (require, exports, lifecycle_1, callbackList_1, winjs_base_1, functional_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[32/*vs/base/common/cancellation*/], __M([0/*require*/,1/*exports*/,5/*vs/base/common/event*/]), function (require, exports, event_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[19/*vs/base/common/async*/], __M([0/*require*/,1/*exports*/,7/*vs/base/common/errors*/,4/*vs/base/common/platform*/,2/*vs/base/common/winjs.base*/,32/*vs/base/common/cancellation*/,8/*vs/base/common/lifecycle*/,5/*vs/base/common/event*/]), function (require, exports, errors, platform, winjs_base_1, cancellation_1, lifecycle_1, event_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[25/*vs/base/node/stdFork*/], __M([0/*require*/,1/*exports*/,26/*path*/,44/*os*/,42/*net*/,16/*child_process*/,11/*vs/base/common/uri*/]), function (require, exports, path, os, net, cp, uri_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[34/*vs/base/common/processes*/], __M([0/*require*/,1/*exports*/,37/*vs/nls!vs/base/common/processes*/,10/*vs/base/common/objects*/,4/*vs/base/common/platform*/,3/*vs/base/common/types*/,30/*vs/base/common/parsers*/]), function (require, exports, NLS, Objects, Platform, Types, parsers_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[28/*vs/base/node/processes*/], __M([0/*require*/,1/*exports*/,26/*path*/,16/*child_process*/,43/*stream*/,25/*vs/base/node/stdFork*/,33/*vs/nls!vs/base/node/processes*/,2/*vs/base/common/winjs.base*/,3/*vs/base/common/types*/,11/*vs/base/common/uri*/,10/*vs/base/common/objects*/,9/*vs/base/common/paths*/,4/*vs/base/common/platform*/,22/*vs/base/node/decoder*/,34/*vs/base/common/processes*/]), function (require, exports, path, cp, stream_1, stdFork_1, nls, winjs_base_1, Types, uri_1, Objects, TPath, Platform, decoder_1, processes_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[27/*vs/base/parts/ipc/node/ipc.cp*/], __M([0/*require*/,1/*exports*/,16/*child_process*/,2/*vs/base/common/winjs.base*/,19/*vs/base/common/async*/,10/*vs/base/common/objects*/,5/*vs/base/common/event*/,24/*vs/base/node/event*/,28/*vs/base/node/processes*/,36/*vs/base/parts/ipc/common/ipc*/]), function (require, exports, child_process_1, winjs_base_1, async_1, objects_1, event_1, event_2, processes_1, ipc_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[29/*vs/workbench/services/search/node/worker/searchWorkerIpc*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[48/*vs/workbench/services/search/node/worker/searchWorkerApp*/], __M([0/*require*/,1/*exports*/,27/*vs/base/parts/ipc/node/ipc.cp*/,29/*vs/workbench/services/search/node/worker/searchWorkerIpc*/,23/*vs/workbench/services/search/node/worker/searchWorker*/]), function (require, exports, ipc_cp_1, searchWorkerIpc_1, searchWorker_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
