...
function _createConnection(input, output, strategy, factories) {
    ...
    let protocolConnection = {
        ...
        onTypeDefinition: (handler) => connection.onRequest(vscode_languageserver_protocol_1.Proposed.TypeDefinitionRequest.type, handler),
        onImplementation: (handler) => connection.onRequest(vscode_languageserver_protocol_1.Proposed.ImplementationRequest.type, handler),
