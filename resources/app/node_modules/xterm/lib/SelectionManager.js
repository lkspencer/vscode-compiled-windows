...
var SelectionManager = (function (_super) {
    ...
    function SelectionManager(_terminal, _buffer, _rowContainer, _charMeasure) {
        ...
        _this._isLineSelectModeActive = false;
        return _this;
    }
    ...
    SelectionManager.prototype._getMouseBufferCoords = function (event) {
        var coords = Mouse.getCoords(event, this._rowContainer, this._charMeasure, this._terminal.cols, this._terminal.rows);
        coords[0]--;
        coords[1]--;
    ...
    SelectionManager.prototype._selectWordAt = function (coords) {
        ...
        this._model.selectionStartLength = Math.min(endIndex - startIndex + leftWideCharCount + rightWideCharCount + 1, this._terminal.cols);
    };
